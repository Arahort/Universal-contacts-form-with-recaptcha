...
<p>Если вам кажется что вы всё сделали правильно, но письма всё равно не приходят - проверьте работает ли на хостинге php функция mail(). Подробнее как это сделать вы можете посмотреть на сайте arahort.pro</p>
